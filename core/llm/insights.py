    ...
    def generate_insights(
        ...
        try:
                ...
                with concurrent.futures.ThreadPoolExecutor() as executor_pool:
                    future = executor_pool.submit(
                        ...
                        self._async_generate_insights(
                            concentration_results, schema, dataset_stats, dataset_id, request_id
                        )
                    )
                    full_insights = future.result(timeout=120)  # Longer timeout for comprehensive insights
            else:
            ...
            fallback_insights = {
                ...
                "risk_assessment": {
                    "level": "medium",
                    "reasons": ["Unable to assess risk level - please review metrics manually"]
                }
            }
        ...
        try:
            ...
            return {
                "insights": {
                    ...
                    "data_summary": {
                        "total_periods": len(concentration_results.get("by_period", [])),
            ...
            return {
                "insights": {
                    ...
                    "risk_assessment": {"level": "medium", "reasons": ["Analysis error"]},
                    "generated_at": f"{request_id or 'unknown'}",
