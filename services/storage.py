...
class StorageService:
    ...
    @staticmethod
    def write_parquet(df: pd.DataFrame, file_path: Union[str, Path], **kwargs) -> str:
        """
    ...
    @staticmethod
    def read_parquet(
        file_path: Union[str, Path], columns: Optional[List[str]] = None
    ) -> pd.DataFrame:
        """
        Read Parquet file.
    ...
    @staticmethod
    def write_csv(df: pd.DataFrame, file_path: Union[str, Path], **kwargs) -> str:
        """
    ...
    @staticmethod
    def save_upload(file_content: bytes, file_path: Union[str, Path]) -> str:
        """
